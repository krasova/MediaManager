...
import com.ostrovskiy.media.security.SecurityUtils;
import com.ostrovskiy.media.service.MailService;
import com.ostrovskiy.media.service.UserService;
import com.ostrovskiy.media.service.dto.UserDTO;
import com.ostrovskiy.media.web.rest.errors.*;
import com.ostrovskiy.media.web.rest.vm.KeyAndPasswordVM;
import com.ostrovskiy.media.web.rest.vm.ManagedUserVM;
...
import com.ostrovskiy.media.service.dto.PasswordChangeDTO;
...
public class AccountResource {
   ...
   * @throws RuntimeException 500 (Internal Server Error) if the current open sessions couldn't be
   *         retrieved
   */
  ...
  public void invalidateSession(@PathVariable String series) throws UnsupportedEncodingException {
    ...
    SecurityUtils.getCurrentUserLogin().flatMap(userRepository::findOneByLogin)
        .ifPresent(u -> persistentTokenRepository.findByUser(u).stream()
            .filter(
                persistentToken -> StringUtils.equals(persistentToken.getSeries(), decodedSeries))
