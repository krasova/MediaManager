...
public class MovieServiceImpl implements MovieService {
    ...
    public MovieServiceImpl(MovieRepository movieRepository, MovieSearchRepository movieSearchRepository) {
    ...
    public Movie save(Movie movie) {
        log.debug("Request to save Movie : {}", movie);        Movie result = movieRepository.save(movie);
