...
const apiUrl = SERVER_API_URL + '/api/movies';
const apiSearchUrl = SERVER_API_URL + '/api/_search/movies';

// Actions

export const getSearchEntities: ICrudSearchAction<IMovie> = query => ({
